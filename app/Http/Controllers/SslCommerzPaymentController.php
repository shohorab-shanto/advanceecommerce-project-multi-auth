...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['invoice_no'] ='EOS'.mt_rand(000000001,99999999);
        ...
        $update_product = DB::table('orders')
            ...
            $post_data['value_b'] = $invoice->email;
            $post_data['value_c'] = $invoice->name;
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $requestData = (array)json_decode($request->cart_json); //to get data
        $post_data = array();
    ...
    public function success(Request $request)
    {
        ...
        if ($order_detials->status == 'Pending') {
            ...
            //start send mail
                ...
                $data = [  //information comming from index and paybyajax
                    'invoice_no' => $request->value_a,
                    'amount' => $amount,
                    'name' => $request->value_b,
                    'email' => $request->value_c,

                ];

                Mail::to($request->value_b)->send(new OrderMail($data)); //mail jabe requested mail e and data object er maddhome OrderMail e pass korlam
