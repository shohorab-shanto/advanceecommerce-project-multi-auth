...
class LanguageController extends Controller
{
    public function Bangla(){
        ...
        Session::put('language','bangla'); //jei language cai seta bosalam .. eta jdi header page er if er sathe mile tahle hindi show korbe nahle else e jeta aca seta show korbe mane english
