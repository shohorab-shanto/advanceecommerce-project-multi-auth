                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 already-registered-login">
                            ...
                            <form class="register-form" action="{{ route('checkout.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="info-title" name="shipping_name" for="exampleInputEmail1"><b>Shipping Name</b> <span>*</span></label>
                                ...
                                <div class="form-group">
                                    <label class="info-title" name="shipping_email" for="exampleInputEmail1"><b>Shipping Email</b> <span>*</span></label>
                                ...
                                <div class="form-group">
                                    <label class="info-title" name="shipping_phone" for="exampleInputEmail1"><b>Phone</b> <span>*</span></label>
                                ...
                                <div class="form-group">
                                    <label class="info-title" name="post_code" for="exampleInputEmail1"><b>Post code</b> <span>*</span></label>
                        ...
                        <div class="col-md-6 col-sm-6 already-registered-login">
                            ...
                            <div class="form-group">
                                <label class="info-title" name="post_code" for="exampleInputEmail1"><b>Notes</b><span>*</span></label>
                ...
                <div class="panel panel-default">
                    ...
                    <hr>
                            <li>
                                ...
                                <strong>SubTotal: </strong> ${{ $cartTotal }} <hr>
                                <strong>GrantTotal: </strong> ${{ $cartTotal }} <hr>
            ...
            if(division_id){
                $.ajax({
                    ...
                    success:function(data) {
                        var d =$('select[name="state_id"]').empty(); //jokhn division change korbe state khali hoiea jabe
