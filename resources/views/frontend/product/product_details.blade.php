                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
                            ...
                            <!-- specific id controller er maddhome dhore ei page compact korci jar jonno direct vaiable er maddhome table e enter korte parteci -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control unicase-form-control selectpicker" style="display: none;" id="color">
                                            ...
                                            <option value={{ $color }}>{{ ucwords($color) }}</option><!-- uc for first latter capital -->
                                            @endforeach
                                        </select>
                                    </div><!-- end form group -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control unicase-form-control selectpicker" style="display: none;" id="size">
                                            ...
                                            <option value="{{ $size }}">{{ ucwords($size) }}</option> <!-- uc for frist latter capital -->
                                            @endforeach
                                        </select>
                                        @endif
