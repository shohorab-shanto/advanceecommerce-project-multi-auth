                        ...
                        <div class="row"> <!--start 4th row-->
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_hin" class="form-control"  data-role="tagsinput" required="" value="{{ $products->product_tags_hin }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" class="form-control" data-role="tagsinput" required="" value="{{ $products->product_size_en }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_hin" class="form-control" data-role="tagsinput" required="" value="{{ $products->product_size_hin }}">
                        ...
                        <div class="row"> <!--start 5th row-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_hin" class="form-control" data-role="tagsinput" required="" value="{{ $products->product_color_hin }}">
                        ...
                        <div class="row"> <!--start 7th row-->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_descp_hin" id="short_descp_hin" class="form-control" required="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="" value="{{ $products->long_descp_en }}">
            ...
            <div class="col-md-12">
				<div class="box bt-3 border-info">
                  ...
                  <form method="post" action="{{ route('update-product-thambnail') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $products->id }}">
                    <input type="hidden" name="old_img" value="{{ $products->product_thambnail }}"> <!-- old pic pass kore dilam-->
                    <div class="row row-sm">
