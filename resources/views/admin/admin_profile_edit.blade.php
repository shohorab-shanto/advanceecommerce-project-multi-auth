                       ...
                       <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <img id="showImage" src="{{ (!empty($editData->profile_photo_path))? url('upload/admin_images/'.$editData->profile_photo_path):url('upload/avatar-1.png') }}"style="width: 100px; height: 100px;">
